...
class FL1Zg_Interference_JHU_rw_HZZ(PhysicsModelBase_NiceSubclasses):
    def getPOIList(self):
...
#        self.modelBuilder.out.var("RF").setAttribute("flatParam")
        ...
        self.modelBuilder.doVar('expr::ai("(@0>0 ? 1 : -1) * sqrt(abs(@0)*{sigma1_HZZ}/{sigmaL1Zg_HZZ})", CMS_zz4l_fai1)'.format(**xsecs))


        self.modelBuilder.factory_('expr::smCoupling_VBF("@0*@3*@1**2 - @0*@1*@2*@3*sqrt({sigmaL1Zg_VBF}/{sigma1_VBF})", RV,a1,ai,muTT)'.format(**xsecs))
        self.modelBuilder.factory_('expr::smCoupling_ZH("@0*@3*@1**2 - @0*@1*@2*@3*sqrt({sigmaL1Zg_ZH}/{sigma1_ZH})", RV,a1,ai,muTT)'.format(**xsecs))
        self.modelBuilder.factory_('expr::smCoupling_WH("@0*@3*@1**2 - @0*@1*@2*@3*sqrt({sigmaL1Zg_WH}/{sigma1_WH})", RV,a1,ai,muTT)'.format(**xsecs))


        self.modelBuilder.factory_('expr::bsmCoupling_VBF("@0*@3*@1**2*{sigmaL1Zg_VBF}/{sigma1_VBF} - @0*@1*@2*@3*sqrt({sigmaL1Zg_VBF}/{sigma1_VBF})", RV,ai,a1,muTT)'.format(**xsecs))
        self.modelBuilder.factory_('expr::bsmCoupling_ZH("@0*@3*@1**2*{sigmaL1Zg_ZH}/{sigma1_ZH} - @0*@1*@2*@3*sqrt({sigmaL1Zg_ZH}/{sigma1_ZH})", RV,ai,a1,muTT)'.format(**xsecs))
        self.modelBuilder.factory_('expr::bsmCoupling_WH("@0*@3*@1**2*{sigmaL1Zg_WH}/{sigma1_WH} - @0*@1*@2*@3*sqrt({sigmaL1Zg_WH}/{sigma1_WH})", RV,ai,a1,muTT)'.format(**xsecs))


        self.modelBuilder.factory_('expr::intCoupling_VBF("@0*@1*@2*@3*sqrt({sigmaL1Zg_VBF}/{sigma1_VBF})*{sigmaa1L1Zgint_VBF}/{sigma1_VBF}", RV,a1,ai,muTT)'.format(**xsecs))
        self.modelBuilder.factory_('expr::intCoupling_ZH("@0*@1*@2*@3*sqrt({sigmaL1Zg_ZH}/{sigma1_ZH})*{sigmaa1L1Zgint_ZH}/{sigma1_ZH}", RV,a1,ai,muTT)'.format(**xsecs))
        self.modelBuilder.factory_('expr::intCoupling_WH("@0*@1*@2*@3*sqrt({sigmaL1Zg_WH}/{sigma1_WH})*{sigmaa1L1Zgint_WH}/{sigma1_WH}", RV,a1,ai,muTT)'.format(**xsecs))
        return ["CMS_zz4l_fai1","RV","RF","muTT"] + super(FL1Zg_Interference_JHU_rw_HZZ, self).getPOIList()
