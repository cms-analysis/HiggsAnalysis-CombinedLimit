...
config.JobType.inputFiles = [os.environ['CMSSW_BASE']+'/src/HiggsAnalysis.CombinedLimit/scripts/FrameworkJobReport.xml', os.environ['CMSSW_BASE']+'/src/HiggsAnalysis.CombinedLimit/scripts/copyRemoteWorkspace.sh', os.environ['CMSSW_BASE']+'/bin/'+os.environ['SCRAM_ARCH']+'/combine']
