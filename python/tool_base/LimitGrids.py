...
class HybridNewGrid(CombineToolBase):
    ...
    def PlotTestStat(self, result, name, opts, poi_vals, point_info=None):
        ...
        hist_alt.GetXaxis().SetTitle("-2 #times ln(^{{}}L_{{{}}}/^{{}}L_{{{}}})".format(opts["alt_label"], opts["null_label"]))
        ...
        pt_r.AddText("{} [{} = {:.1f}, {} = {:.1f}]".format(opts["model_label"], opts["poi_labels"][0], poi_vals[0], opts["poi_labels"][1], poi_vals[1]))
        pt_r.AddText(
