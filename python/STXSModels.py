...
def getSTXSProdDecMode(bin,process,options):
    ...
    if "_" in process: 
        ...
        for Y in ['2016','2017','2018']:
            if Y in processSource.split("_")[-1]: processSource = "_".join(processSource.split("_")[0:-1])
        #print processSource
    foundDecay = None
...
class StageOnePTwo(STXSBaseModel):
    ...
    def __init__(self):
        ...
        self.FINEPROCESSES = [x for v in stage1_2_fine_procs.itervalues() for x in v]
        self.mergeSchemes={}
	...
	for P in self.PROCESSES:
        ...
        for P in self.FINEPROCESSES:
            ...
            for dec in SM_HIGG_DECAYS:                
                ...
                if (D in allDecs): continue
                allDecs.append(D)
                print "stage1_2_fine_procs ", self.stage1_2_fine_procs
