...
class FA3_Interference_JHU_ggHSyst_rw_HZZ(PhysicsModelBase_NiceSubclasses):
    def getPOIList(self):
...
#        self.modelBuilder.doVar("CMS_zz4l_fai1[0.0,-1.0,1.0]");
        ...
        #self.modelBuilder.doSet("POI","CMS_zz4l_fai1,fa3_ggH,RV,RF")
#        self.modelBuilder.out.var("RF").setAttribute("flatParam")
        
        self.modelBuilder.doVar('expr::a1("sqrt(1-abs(@0))", CMS_zz4l_fai1)')
        self.modelBuilder.doVar('expr::ai("(@0>0 ? 1 : -1) * sqrt(abs(@0)*{sigma1_HZZ}/{sigma3_HZZ})", CMS_zz4l_fai1)'.format(**xsecs))
        ...
        self.modelBuilder.factory_('expr::smCoupling_VBF("@0*@3*@1**2 - @0*@1*@2*@3*sqrt({sigma3_VBF}/{sigma1_VBF})", RV,a1,ai,muTT)'.format(**xsecs))
        self.modelBuilder.factory_('expr::smCoupling_ZH("@0*@3*@1**2 - @0*@1*@2*@3*sqrt({sigma3_ZH}/{sigma1_ZH})", RV,a1,ai,muTT)'.format(**xsecs))
        self.modelBuilder.factory_('expr::smCoupling_WH("@0*@3*@1**2 - @0*@1*@2*@3*sqrt({sigma3_WH}/{sigma1_WH})", RV,a1,ai,muTT)'.format(**xsecs))

        self.modelBuilder.factory_('expr::smCoupling_ggH("@0*@2*@1**2", RF,a1_ggH,muTT)'.format(**xsecs))

        

        self.modelBuilder.factory_('expr::bsmCoupling_VBF("@0*@3*@1**2*{sigma3_VBF}/{sigma1_VBF} - @0*@1*@2*@3*sqrt({sigma3_VBF}/{sigma1_VBF})", RV,ai,a1,muTT)'.format(**xsecs))
        self.modelBuilder.factory_('expr::bsmCoupling_ZH("@0*@3*@1**2*{sigma3_ZH}/{sigma1_ZH} - @0*@1*@2*@3*sqrt({sigma3_ZH}/{sigma1_ZH})", RV,ai,a1,muTT)'.format(**xsecs))
        self.modelBuilder.factory_('expr::bsmCoupling_WH("@0*@3*@1**2*{sigma3_WH}/{sigma1_WH} - @0*@1*@2*@3*sqrt({sigma3_WH}/{sigma1_WH})", RV,ai,a1,muTT)'.format(**xsecs))


        self.modelBuilder.factory_('expr::bsmCoupling_ggH("@0*@2*@1**2", RF,a3_ggH,muTT)'.format(**xsecs))


        self.modelBuilder.factory_('expr::intCoupling_VBF("@0*@1*@2*@3*sqrt({sigma3_VBF}/{sigma1_VBF})*{sigmaa1a3int_VBF}/{sigma1_VBF}", RV,a1,ai,muTT)'.format(**xsecs))
        self.modelBuilder.factory_('expr::intCoupling_ZH("@0*@1*@2*@3*sqrt({sigma3_ZH}/{sigma1_ZH})*{sigmaa1a3int_ZH}/{sigma1_ZH}", RV,a1,ai,muTT)'.format(**xsecs))
        self.modelBuilder.factory_('expr::intCoupling_WH("@0*@1*@2*@3*sqrt({sigma3_WH}/{sigma1_WH})*{sigmaa1a3int_WH}/{sigma1_WH}", RV,a1,ai,muTT)'.format(**xsecs))

        return ["CMS_zz4l_fai1","RV","RF","muTT","fa3_ggH"] + super(FA3_Interference_JHU_ggHSyst_rw_HZZ, self).getPOIList()
