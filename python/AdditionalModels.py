...
class C8(SMLikeHiggsModel):
    ...
    def setup(self):
        ...
        self.modelBuilder.factory_(
            'expr::c8_Gscal_tot("(@1+@2+@3+@4+@5+@6)/(1-@0-@7)",BRInv,c8_Gscal_Vectors, c8_Gscal_tau, c8_Gscal_top, c8_Gscal_bottom, c8_Gscal_gluon, c8_Gscal_gamma,BRUndet)'
        )
...
class CWidth(SMLikeHiggsModel):
    ...
    def setup(self):
        ...
        if self.doWidth:
            self.modelBuilder.factory_(
                'expr::c7_Gscal_tot("(@1+@2+@3+@4+@5+@6)<=@0?@0:0.001",Gscale,c7_Gscal_Vectors, c7_Gscal_tau, c7_Gscal_top, c7_Gscal_bottom, c7_Gscal_gluon, c7_Gscal_gamma)'
            )
            self.modelBuilder.factory_(
                'expr::BRInvUndet("1 - (@1+@2+@3+@4+@5+@6)/@0",c7_Gscal_tot,c7_Gscal_Vectors, c7_Gscal_tau, c7_Gscal_top, c7_Gscal_bottom, c7_Gscal_gluon, c7_Gscal_gamma)'
            )
        else:
            self.modelBuilder.factory_(
                'expr::c7_Gscal_tot("(@1+@2+@3+@4+@5+@6)/(1-@0)",BRInvUndet,c7_Gscal_Vectors, c7_Gscal_tau, c7_Gscal_top, c7_Gscal_bottom, c7_Gscal_gluon, c7_Gscal_gamma)'
            )
