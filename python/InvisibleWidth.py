...
class InvisibleWidth(SMLikeHiggsModel):
    ...
    def setup(self):
        ...
        self.modelBuilder.factory_(
            'expr::invisibleWidth_Gscal_tot("(@1+@2+@3+@4+@5+@6)/(1-@0)",BRInvUndet,invisibleWidth_Gscal_Vectors, invisibleWidth_Gscal_tau, invisibleWidth_Gscal_top, invisibleWidth_Gscal_bottom, invisibleWidth_Gscal_gluon, invisibleWidth_Gscal_gamma)'
        )
