...
LIBS = $(ROOTLIBS) -L$(BOOST)/lib -L$(VDT)/lib -l RooFit -lRooFitCore -l RooStats -l Minuit -l Foam -lboost_filesystem -lboost_program_options -lboost_system -lvdt
...
dirs:
	...
	@ln -sd ../../../python $(LIB_DIR)/python/HiggsAnalysis/CombinedLimit
