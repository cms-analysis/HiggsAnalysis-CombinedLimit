...
signals = ['ZH_lep_PTV_75_150_hbb','ZH_lep_PTV_150_250_0J_hbb', 'ZH_lep_PTV_150_250_GE1J_hbb', 'ZH_lep_PTV_250_400_hbb', 'ZH_lep_PTV_GT400_hbb']
bins = ['vhbb_Zee_75_150_13TeV','vhbb_Zee_150_250_noj_13TeV', 'vhbb_Zee_150_250_wj_13TeV', 'vhbb_Zee_250_400_13TeV', 'vhbb_Zee_gt400_13TeV']
...
for i,b in enumerate(bins):
    ...
    for j,p in enumerate(signals): hist.SetBinContent(j+1,i+1,hist.GetBinContent(j+1,i+1)/total_signal)
c1 = ROOT.TCanvas()
c1.cd()
pads=plot.OnePad()
