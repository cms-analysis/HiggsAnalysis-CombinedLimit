...
#     pdfs["%s_exp"%cat].fitTo( data[cat], ROOT.RooFit.Range(fit_range), ROOT.RooFit.Minimizer("Minuit2","minimize"),ROOT.RooFit.SumW2Error(True) )
# 
...
#     pdfs["%s_poly"%cat].fitTo( data[cat], ROOT.RooFit.Range(fit_range), ROOT.RooFit.Minimizer("Minuit2","minimize"),ROOT.RooFit.SumW2Error(True) )
# 
...
#     pdfs["%s_pow"%cat].fitTo( data[cat], ROOT.RooFit.Range(fit_range), ROOT.RooFit.Minimizer("Minuit2","minimize"),ROOT.RooFit.SumW2Error(True) )
# 
...
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
# # Finally lets calculate the systematic yield variations to add to the datacard
