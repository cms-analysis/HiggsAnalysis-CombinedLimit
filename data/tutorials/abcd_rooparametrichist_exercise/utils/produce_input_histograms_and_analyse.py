...
def print_expected_background_in_regions_and_closure(
    n_bkg_A, n_bkg_B, n_bkg_C, n_bkg_D, bkg_A, bkg_B, bkg_C, bkg_D, signals_A, signals_B, signals_C, signals_D, signals_expected_rates
):
...
def main():
    ...
    # print closure test
    print_expected_background_in_regions_and_closure(
        n_bkg_A, n_bkg_B, n_bkg_C, n_bkg_D, bkg_A, bkg_B, bkg_C, bkg_D, signals_A, signals_B, signals_C, signals_D, signals_expected_rates
    )
