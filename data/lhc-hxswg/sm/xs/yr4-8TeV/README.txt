8 TeV Cross-sections for Moriond 2016 - sourced from https://twiki.cern.ch/twiki/pub/LHCPhysics/LHCHXSWG/Higgs_XSBR_YR4_update.xlsx
...
- Separate numbers for PDF and alpha_S are also provided (except for bbH for which they are combined):
