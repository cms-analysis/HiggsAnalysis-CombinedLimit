13 TeV Cross-sections for Moriond 2016 - sourced from https://twiki.cern.ch/twiki/pub/LHCPhysics/LHCHXSWG/Higgs_XSBR_YR4_update.xlsx
...
- There are numbers provided separately for the cross-sections of (W+)H and (W-)H in addition to the sum of the two.
