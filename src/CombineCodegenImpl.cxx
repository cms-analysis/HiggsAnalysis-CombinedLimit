...
#define CODEGEN_INTEGRAL_IMPL(CLASS_NAME) \
std::string codegenIntegralImpl(CLASS_NAME &arg0, int code, const char *rangeName, CodegenContext &ctx)
...
#define CODEGEN_INTEGRAL_IMPL(CLASS_NAME)            \
std::string CLASS_NAME::buildCallToAnalyticIntegral( \
