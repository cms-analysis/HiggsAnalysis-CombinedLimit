...
#include "HiggsAnalysis/CombinedLimit/interface/AsymptoticCLsLimits.h"
...
double AsymptoticCLsLimits::rAbsAccuracy_ = 0.0005;
double AsymptoticCLsLimits::rRelAccuracy_ = 0.005;
std::string AsymptoticCLsLimits::what_ = "both"; 
std::string AsymptoticCLsLimits::gridFileName_ = ""; 
bool  AsymptoticCLsLimits::qtilde_ = true; 
bool  AsymptoticCLsLimits::picky_ = false; 
bool  AsymptoticCLsLimits::noFitAsimov_ = false; 
bool  AsymptoticCLsLimits::useGrid_ = false; 
bool  AsymptoticCLsLimits::newExpected_ = true; 
std::string AsymptoticCLsLimits::minosAlgo_ = "stepping"; 
std::string AsymptoticCLsLimits::minimizerAlgo_ = "Minuit2";
float       AsymptoticCLsLimits::minimizerTolerance_ = 0.01;
int         AsymptoticCLsLimits::minimizerStrategy_  = 0;
double AsymptoticCLsLimits::rValue_ = 1.0;
bool AsymptoticCLsLimits::strictBounds_ = false;


AsymptoticCLsLimits::AsymptoticCLsLimits() : 
LimitAlgo("AsymptoticCLsLimits specific options") {
...
void AsymptoticCLsLimits::applyOptions(const boost::program_options::variables_map &vm) {
    if (vm.count("singlePoint") && !vm["singlePoint"].defaulted()) {
        if (!vm["run"].defaulted()) throw std::invalid_argument("AsymptoticCLsLimits: when using --singlePoint you can't use --run (at least for now)");
        what_ = "singlePoint";
    } else {
        if (what_ != "observed" && what_ != "expected" && what_ != "both" && what_ != "blind") 
            throw std::invalid_argument("AsymptoticCLsLimits: option 'run' can only be 'observed', 'expected' or 'both' (the default) or 'blind' (a-priori expected)");
    }
...
void AsymptoticCLsLimits::applyDefaultOptions() { 
    what_ = "observed"; noFitAsimov_ = true; // faster
}

bool AsymptoticCLsLimits::run(RooWorkspace *w, RooStats::ModelConfig *mc_s, RooStats::ModelConfig *mc_b, RooAbsData &data, double &limit, double &limitErr, const double *hint) {
...
bool AsymptoticCLsLimits::runLimit(RooWorkspace *w, RooStats::ModelConfig *mc_s, RooStats::ModelConfig *mc_b, RooAbsData &data, double &limit, double &limitErr, const double *hint) {
...
double AsymptoticCLsLimits::getCLs(RooRealVar &r, double rVal, bool getAlsoExpected, double *limit, double *limitErr) {
...
std::vector<std::pair<float,float> > AsymptoticCLsLimits::runLimitExpected(RooWorkspace *w, RooStats::ModelConfig *mc_s, RooStats::ModelConfig *mc_b, RooAbsData &data, double &limit, double &limitErr, const double *hint) {
...
float AsymptoticCLsLimits::findExpectedLimitFromCrossing(RooAbsReal &nll, RooRealVar *r, double rMin, double rMax, double nll0, double clb) {
...
float AsymptoticCLsLimits::calculateLimitFromGrid(RooRealVar *r , double quantile, double alpha){	
...
RooAbsData * AsymptoticCLsLimits::asimovDataset(RooWorkspace *w, RooStats::ModelConfig *mc_s, RooStats::ModelConfig *mc_b, RooAbsData &data) {
    // Do this only once
