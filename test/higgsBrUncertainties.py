...
parser.add_option(
    ...
    default="5.3f",
    type="string",
    help="Format string (default: 5.3f)",
)
parser.add_option(
    "-k",
    "--kind",
    ...
    default="lnN",
    type="string",
    help="Kind of output: lnN for log-normal kappas, % for percent, eps for bare values ",
)
parser.add_option(
    "--mp",
    "--merge-param",
    ...
    default=False,
    action="store_true",
    help="Merge parametric uncertainties into a single entry",
)
parser.add_option(
    "-t",
    "--threshold",
