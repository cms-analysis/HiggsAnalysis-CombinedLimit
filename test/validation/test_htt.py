...
suite += [
    (
        ...
        WorkspaceWithExpectedTest(
            "Summer13_HTT_RV_RF",
            datacardGlob("htt/125/htt_mt_*_8TeV.txt"),
            M,
...
##############################################
minimizer = (
    "--robustFit=1 --X-rtd FITTER_NEW_CROSSING_ALGO --minimizerAlgoForMinos=Minuit2 --minimizerToleranceForMinos=0.1 "
...
suite += [
    (
        ...
        "HTT",
        WorkspaceWithExpectedTest(
            "Summer13_HTT_SIG_OBS",
            datacardGlob("htt/125/htt_mt_*_8TeV.txt"),
            M,
            "--default-morphing=shape2",
            minimizer + " --significance",
            125,
        ),
    )
]
suite += [
    (
        ...
        "HTT",
        WorkspaceWithExpectedTest(
            "Summer13_HTT_SIG_EXP",
            datacardGlob("htt/125/htt_mt_*_8TeV.txt"),
            M,
            "--default-morphing=shape2",
            minimizer + " --significance --expectSignal=1 -t -1 --toysFreq",
            125,
        ),
    )
]
