...
Currently, the recommended tag is **v10.3.2**: [see release notes](https://github.com/cms-analysis/HiggsAnalysis-CombinedLimit/releases/tag/v10.3.2)
...
cmsenv
git -c advice.detachedHead=false clone --depth 1 --branch v10.3.2 https://github.com/cms-analysis/HiggsAnalysis-CombinedLimit.git HiggsAnalysis/CombinedLimit
