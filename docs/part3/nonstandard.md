...
4. Run additional scans using the post-fit workspace sequentially adding another group to the list of groups to freeze
...
5. Run one last scan freezing all of the constrained nuisances (this represents the statistics only uncertainty). 
...
6. Use the `combineTool` script `plot1D.py` to report the breakdown of uncertainties. 
