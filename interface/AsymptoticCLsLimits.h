#ifndef HiggsAnalysis_CombinedLimit_AsymptoticCLsLimits_h
#define HiggsAnalysis_CombinedLimit_AsymptoticCLsLimits_h
/** \class AsymptoticCLsLimits
 *
...
class AsymptoticCLsLimits : public LimitAlgo {
public:
  AsymptoticCLsLimits() ; 
  ...
  virtual const std::string& name() const { static std::string name_ = "AsymptoticCLsLimits"; return name_; }
private:
