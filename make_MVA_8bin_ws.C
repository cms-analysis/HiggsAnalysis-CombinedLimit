...
void make_MVA_8bin_ws(const string year = "2016", const string infile_path = "Keras_V1.2.5_v4", const string model = "RPV", const string mass = "550", const string dataType = "pseudodata", const string syst = "", bool shared = true, bool TTonly = false) {
  ...
  D1_OTHER_htUp->SetName(("D1_OTHER_ht_"+year+"Up"));
  D2_OTHER_htUp->SetName(("D2_OTHER_ht_"+year+"Up"));
  D3_OTHER_htUp->SetName(("D3_OTHER_ht_"+year+"Up"));
  D4_OTHER_htUp->SetName(("D4_OTHER_ht_"+year+"Up"));
  D1_OTHER_htUp->Write();
  D2_OTHER_htUp->Write();
  D3_OTHER_htUp->Write();
  D4_OTHER_htUp->Write();
  ...
  D1_OTHER_htDown->SetName(("D1_OTHER_ht_"+year+"Down"));
  D2_OTHER_htDown->SetName(("D2_OTHER_ht_"+year+"Down"));
  D3_OTHER_htDown->SetName(("D3_OTHER_ht_"+year+"Down"));
  D4_OTHER_htDown->SetName(("D4_OTHER_ht_"+year+"Down"));
  ...
  D1_OTHER_puUp->SetName(("D1_OTHER_pu_"+year+"Up"));
  D2_OTHER_puUp->SetName(("D2_OTHER_pu_"+year+"Up"));
  D3_OTHER_puUp->SetName(("D3_OTHER_pu_"+year+"Up"));
  D4_OTHER_puUp->SetName(("D4_OTHER_pu_"+year+"Up"));
  D1_OTHER_puUp->Write();
  D2_OTHER_puUp->Write();
  D3_OTHER_puUp->Write();
  D4_OTHER_puUp->Write();
  ...
  D1_OTHER_puDown->SetName(("D1_OTHER_pu_"+year+"Down"));
  D2_OTHER_puDown->SetName(("D2_OTHER_pu_"+year+"Down"));
  D3_OTHER_puDown->SetName(("D3_OTHER_pu_"+year+"Down"));
  D4_OTHER_puDown->SetName(("D4_OTHER_pu_"+year+"Down"));
